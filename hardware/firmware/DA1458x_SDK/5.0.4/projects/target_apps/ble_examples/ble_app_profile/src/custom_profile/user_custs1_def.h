...
// BBPG control point
#define DEF_CUST1_BBPG_CTRL_POINT_UUID_128 {0x34, 0x33, 0x32, 0x31, 0x30, 0x29, 0x28, 0x27, 0x26, 0x25, 0x24, 0x23, 0x22, 0x21, 0x20, 0x19}
...
// BBPG control point data len
#define DEF_CUST1_BBPG_CTRL_POINT_CHAR_LEN 1
...
// BBPG control point, characteristics description name
#define CUST1_BBPG_CONTROL_POINT_USER_DESC  "BBPG Control Point"
...
enum
{
    ...
    // BBPG CONTROL POINT SERVICE DATA BASE ADDING
    CUST1_IDX_BBPG_CONTROL_POINT_CHAR,
    CUST1_IDX_BBPG_CONTROL_POINT_VAL,
    CUST1_IDX_BBPG_CONTROL_POINT_USER_DESC,
