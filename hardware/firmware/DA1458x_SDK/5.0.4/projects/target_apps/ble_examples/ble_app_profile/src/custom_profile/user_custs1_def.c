...
// BBPG CONTROL POINT ATTRIBUTE VALUE DECLARE AND ASSIGN
static uint8_t CUST1_BBPG_CTRL_POINT_UUID_128[ATT_UUID_128_LEN]  = DEF_CUST1_BBPG_CTRL_POINT_UUID_128;

static struct att_char128_desc custs1_bbpg_ctrl_point_char  = {ATT_CHAR_PROP_WR, // properties
                                                              {0, 0}, // handler
                                                              DEF_CUST1_BBPG_CTRL_POINT_UUID_128}; // UUID
...
struct attm_desc_128 custs1_att_db[CUST1_IDX_NB] =
{
    ...
    // BBPG CONTROL POINT CHARACTERISTIC DECLARATION
    [CUST1_IDX_BBPG_CONTROL_POINT_CHAR] = {(uint8_t*)&att_decl_char, ATT_UUID_16_LEN, PERM(RD, ENABLE), 
                                            sizeof(custs1_bbpg_ctrl_point_char), sizeof(custs1_bbpg_ctrl_point_char), (uint8_t*)&custs1_bbpg_ctrl_point_char}, 

    // BBPG Control Point Characteristic Value 
    [CUST1_IDX_BBPG_CONTROL_POINT_VAL] = {CUST1_BBPG_CTRL_POINT_UUID_128, ATT_UUID_128_LEN, PERM(WR, ENABLE), 
                                           DEF_CUST1_BBPG_CTRL_POINT_CHAR_LEN, 0, NULL}, 

    // BBPG Control Point Characteristic User Description 
    [CUST1_IDX_BBPG_CONTROL_POINT_USER_DESC] = {(uint8_t*)&att_decl_user_desc, ATT_UUID_16_LEN, PERM(RD, ENABLE), 
                                            sizeof(CUST1_BBPG_CONTROL_POINT_USER_DESC) - 1, sizeof(CUST1_BBPG_CONTROL_POINT_USER_DESC) - 1, CUST1_BBPG_CONTROL_POINT_USER_DESC},
