...
static const struct app_callbacks user_app_callbacks = {
    .app_on_connection              = user_app_connection, // connecting complete action
    .app_on_disconnect              = user_app_disconnect, // disconnection action
    ...
    .app_on_db_init_complete        = default_app_on_db_init_complete, // start advertise action
