 ...
 *
 * File:      sc14580.h
 * Generated: Thu Jan 24 14:51:00 MET 2013
 * By:        nmoschop					    
 * Country:   The Netherlands
 *
 *------------------------------------------------------------------------------------------------------------------------
 * Header    : $Header: /services/syncdata/hazelaar/8000/server_vault/bb/tester/development/software_include/sc14580a/datasheet.h.rca 1.92 Thu Jan 24 14:52:04 2013 nmoschop Experimental $
 * Date      : $Date: Thu Jan 24 14:52:04 2013 $
 *
 *------------------------------------------------------------------------------------------------------------------------
 * 
 *  Id       : $Id: datasheet.h.rca 1.92 Thu Jan 24 14:52:04 2013 nmoschop Experimental $
 *
 *  Log      : $Log: datasheet.h.rca $
 *  Log      : 
 *  Log      :  Revision: 1.92 Thu Jan 24 14:52:04 2013 nmoschop
 *  Log      :  added TWIRQ at the BLE registers
 *
 *------------------------------------------------------------------------------------------------------------------------
 */
...
#define BLE_GPR0             (0x400000)
#define BLE_GPR1             (0x800000)
...
/*=============================*/
{
    ...
    WORD BITFLD_RC16M_CUR_SET        : 3;
};

#define RC16M_ENABLE         (0x0001)
#define RC16M_TRIM           (0x001E)
#define RC16M_CUR_SET        (0x00E0)
...
/*=============================*/
{
    WORD BITFLD_DCDC_AUTO_CAL        : 1;
    WORD BITFLD_DCDC_VBAT1V_LEV      : 3;
    WORD BITFLD_DCDC_MODE            : 4;
...
#define DCDC_AUTO_CAL        (0x0001)
#define DCDC_VBAT1V_LEV      (0x000E)
#define DCDC_MODE            (0x00F0)
